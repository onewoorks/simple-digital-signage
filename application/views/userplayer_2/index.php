<html>
    ...
    <?php
    $medias = json_decode($data['content']['user_content']['media'], true);;
    ?>
    <body id='body' style='width: 1280px; width:600px; overflow: hidden;'>
        <div class='container-fluid' style="width: 1280px;" >
            <div class="row row-top-flex" >
                ...
                <div class="col-xs-3 text-center">
                    ...
                    ?>
                    <img src='<?= ROOT_URL; ?>buckets/<?= $menu['logo']; ?>' class='img-responsive' style='padding-top:0px;' />
                    <br />
